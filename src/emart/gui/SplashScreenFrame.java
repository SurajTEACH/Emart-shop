...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emart/images/slapscreen.jpg"))); // NOI18N
...
class SplashThread extends Thread
{
    public void run()
    {
        ...
        while( jProgressBar1.getValue()<jProgressBar1.getMaximum())
        {
            ...
            {
                JOptionPane.showMessageDialog(null,"Error in Thread Interrupted"," Error!",JOptionPane.INFORMATION_MESSAGE); 
               ex.printStackTrace();
            }
        }
